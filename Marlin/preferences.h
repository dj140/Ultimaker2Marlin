...
#define EEPROM_PID_BED 0x43A + 33  // 12 Byte
#define EEPROM_STEPS_E2 0x446 + 33// 4 Byte
#define EEPROM_AXIS_DIRECTION 0x44A + 33 // 1 Byte
#define EEPROM_RESERVED 0x44B + 33 // next position
