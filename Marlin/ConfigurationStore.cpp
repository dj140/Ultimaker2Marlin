...
void _EEPROM_writeData(int &pos, uint8_t* value, uint8_t size)
{
  uint8_t* readbackData;
    do
    {
        ...
        readbackData = eeprom_read_byte((unsigned char*)pos);
        SERIAL_ECHO_START;
        SERIAL_ECHOPAIR("address: ",(unsigned char*)pos);
        SERIAL_ECHOPAIR("readbackData: ",(float*)readbackData);
        SERIAL_ECHOPAIR("writeData: ",(float*)*value);
        SERIAL_EOL;
        pos++;
        value++;
    }while(--size);
...
void _EEPROM_readData(int &pos, uint8_t* value, uint8_t size)
{
    do
    {
        *value = eeprom_read_byte((unsigned char*)pos);
        SERIAL_ECHO_START;
        SERIAL_ECHOPAIR("address: ",(unsigned char*)pos);
        SERIAL_ECHOPAIR("readbackData: ",(float*)*value);
        SERIAL_EOL;
        pos++;
        value++;
    }while(--size);
